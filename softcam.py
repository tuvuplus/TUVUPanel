...
SCREEN_SOFTCAM = """
    <screen position="center,center" size="1280,720" title="TUVUPanel">
		...
		<widget font="Regular;16" halign="center" name="key_red" position="650,637" size="120,35" transparent="1" valign="center" zPosition="2" />
		<widget font="Regular;16" halign="center" name="key_green" position="800,637" size="120,35" transparent="1" valign="center" zPosition="2" />
		<widget font="Regular;16" halign="center" name="key_yellow" position="900,637" size="120,35" transparent="1" valign="center" zPosition="2" />
		<widget font="Regular;16" halign="center" name="key_blue" position="1000,637" size="120,35" transparent="1" valign="center" zPosition="2" />
	</screen>"""
